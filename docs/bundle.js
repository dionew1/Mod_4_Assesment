...
const displayWord = (wordInfo) => {
  ...
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#top-word-header").append(
    `${topWord} (${topCount})`
  )
}

const evaluateWords = () => {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.added-words').remove()
  let message = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#message').val()
  ...
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#message').val('')
}

__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#button-break-down').on('click', evaluateWords)

__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#message').on('keypress', (event) => {
  if(13 == event.keyCode) {
